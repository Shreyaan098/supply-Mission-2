...
function setup() {
	...
	packageSprite=createSprite(width/2, 400, 10,10);
   ...
   left.shapeColor="red"
   leftBody=Bodies.rectangle(width/2,610,20,100,{isStatic:true});
   World.add(world,leftBody)
   bottom=createSprite(width/2,650,200,20)
   bottom.shapeColor="red"
   bottomBody=Bodies.rectangle(width/2+100,620,200,20,{isStatic:true});
